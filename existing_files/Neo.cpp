...
void moveNeo(void)
{
	...
	{
		if (objectsIteration == 6 || objectsIteration == 7 || objectsIteration == 8)
		{
			if ((gfTranslateNeoX >= -50.0f) && (gfNeoRotate_Y < 300.0f))
			{
				gfTranslateNeoX -= 1.0f * gfNeoSpeed / 60;
				updateNormalWalk();
			}
