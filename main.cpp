...
GLuint textureLegoChest[4];
GLuint textureLegoFace[4];
...
void initialize(void) {
	...
	LoadGLTextures(&textureLegoChest[0], MAKEINTRESOURCE(ID_BITMAP_CHEST_0));
	LoadGLTextures(&textureLegoChest[1], MAKEINTRESOURCE(ID_BITMAP_CHEST_1));
	LoadGLTextures(&textureLegoChest[2], MAKEINTRESOURCE(ID_BITMAP_CHEST_2));
	LoadGLTextures(&textureLegoChest[3], MAKEINTRESOURCE(ID_BITMAP_CHEST_3));

	LoadGLTextures(&textureLegoFace[0], MAKEINTRESOURCE(ID_BITMAP_FACE_0));
	LoadGLTextures(&textureLegoFace[1], MAKEINTRESOURCE(ID_BITMAP_FACE_1));
	LoadGLTextures(&textureLegoFace[2], MAKEINTRESOURCE(ID_BITMAP_FACE_2));
	LoadGLTextures(&textureLegoFace[3], MAKEINTRESOURCE(ID_BITMAP_FACE_3));
...
void legoCharaters() {
	...
	if (objectsIteration == 2 || objectsIteration == 3 || objectsIteration == 4 || objectsIteration == 9 || objectsIteration == 10 || objectsIteration == 11 || objectsIteration == 12 || objectsIteration == 13 || objectsIteration == 14 || objectsIteration == 15 || objectsIteration == 16 || objectsIteration == 17 || objectsIteration == 18  || objectsIteration == 19)
	{
		...
		DrawLegoCharacters(textureLegoChest, textureLegoFace);
