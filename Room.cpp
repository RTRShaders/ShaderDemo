...
void moveCamera(void) {
	...
	if (objectsIteration == 12 || objectsIteration == 11) { //Lego
		gfCameraMoveZ += 0.05f;
		gfCameraMoveX -= 0.1f;
...
*/	if (objectsIteration == 19) { //Shaders
		...
		cameraPosition.y = 3.9f;
		cameraPosition.z = moveZ;
		centerLookAt.x = 13.3f;
		centerLookAt.y = 5.0f;
		centerLookAt.z = 0.0f;
	}
	/*
...
void fillCameraObjectInfo() {
	...
	arrayOfObjectInfo[arrayIndex].speed = 0.05f;
	...
	arrayOfObjectInfo[arrayIndex].centerOflookAt.y = 10.0f;
	arrayOfObjectInfo[arrayIndex].centerOflookAt.z = watchPosition.z;
	arrayOfObjectInfo[arrayIndex].speed = 0.65f;
	arrayOfObjectInfo[arrayIndex].endPosition = 40.0f;
	arrayOfObjectInfo[arrayIndex].isRotation = false;
	...
	arrayOfObjectInfo[arrayIndex].centerOflookAt.y = 10.0f;
	arrayOfObjectInfo[arrayIndex].centerOflookAt.z = watchPosition.z;
	arrayOfObjectInfo[arrayIndex].speed = 0.2f;
...
void drawRoom() {
	...
	*/
	...
	if (objectsIteration == 9 || objectsIteration == 10) 
